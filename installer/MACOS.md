...
3. Scarica l'artifact `Cpython_interpreter_macos_dmg` (`Cpython_interpreter_64x_win.dmg`)
4. Su Mac: apri il `.dmg`, trascina `Cpython_interpreter.app` in **Applicazioni**
